    ...
    <nav className='w-full flex items-center z-20 h-15 text-sm shadow-xl absolute top-0 border-b-gray-300 border-b bg-white'>
        <ul className='flex items-center justify-center gap-11 w-full '>
            ...
            <div className='relative group h-15 flex items-center'>
              <button className='py-2.5 px-4 cursor-pointer rounded-2xl hover:bg-amber-50 font-medium'>Job Bootcamps</button>
            ...
            <div className=' group h-15 flex items-center'>
              <button className='py-3 px-4 cursor-pointer hover:bg-amber-50 rounded-2xl font-medium'>IIT Certifications</button>
              <div className='w-screen h-104 absolute z-[-1] border-t border-gray-200 left-0 opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto pointer-events-none -bottom-104 rounded-b-3xl bg-white shadow-lg flex'>
                <div className="tabsection1 flex-1/10 rounded-r-3xl gap-3 flex flex-col items-end px-5 py-10 bg-[var(--bg-almost-white-2)]">
                  ...
                  <button className='px-4 py-4 rounded-2xl items-center bg-pink-100 w-50 justify-between flex'>For graduates <i>></i></button>
                  <button className='px-4 py-4 rounded-2xl items-center bg-pink-100 w-50 justify-between flex'>For collage students <i>></i></button>
                </div>
            ...
            <div className='relative group h-15 flex items-center'>
              <button className='py-3 px-4 cursor-pointer hover:bg-amber-50 rounded-2xl font-medium'>New Launches</button>
